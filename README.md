...
<body>
    <div class="container">
        ...
        <div class="whatsapp-info">
            <p>WhatsApp咨询: <a href="https://wa.link/qiuzhijia" id="direct-whatsapp-link" target="_blank">点击直接打开WhatsApp</a></p>
            <p>或添加号码: <strong>+60136219856</strong></p>
        </div>
    ...
    <script>
        ...
        const PHONE_NUMBER = '+60136219856';
